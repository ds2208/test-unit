        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">@lang('Autori')</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">@lang('Search Autori')</h3>
                        <div class="card-tools">
                            <a href="{{route('admin.users.add')}}" class="btn btn-success">
                                <i class="fas fa-plus-square"></i>
                                @lang('Dodaj novog autora')
                            </a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                            ...
                            <div class="row">
                                <div class="col-md-2 form-group">
                                    ...
                                    <select class="form-control" name="status">
                                        <option value="">-- @lang('Sve') --</option>
                                        <option value="1">@lang('Validan')</option>
                                        <option value="0">@lang('Greska')</option>
                                    </select>
                                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">@lang('Svi autori')</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="entities-list-table" class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">@lang('Slika')</th>
                                    <th>@lang('E-mail')</th>
                                    <th>@lang('Ime')</th>
                                    <th>@lang('Slika')</th>
                                    <th class="text-center">@lang('Kreiran')</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{__("Deaktiviraj Authora")}}</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>{{__("Da li si siguran da želiš da deaktiviraš autora?")}}</p>
...
<form action="{{route('admin.users.enable')}}" method="post" class="modal fade" id="enable-modal">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{__("Aktiviraj Authora")}}</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>{{__("Da li si siguran da želiš da aktiviraš autora?")}}</p>
                <strong data-container="name"></strong>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">{{__("Prekini")}}</button>
